# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in UMRstaff.
...
import umrstaff
from umrstaff import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': umrstaff.model,
    'DBSession': umrstaff.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "7d9e17ae-2667-41e0-8898-c0f4986a43c0",
